...
public final class MainPreferencePage extends AbstractBindingPreferencesPage {
  ...
  private class ContentsComposite extends AbstractBindingComposite {
    public ContentsComposite(Composite parent,
      ...
      {
        {
          new Label(this, SWT.NONE).setText(PreferencesMessages.MainPreferencePage_defaultWidth);
        ...
        {
          new Label(this, SWT.NONE).setText(PreferencesMessages.MainPreferencePage_defaultHeight);
          Text text = new Text(this, SWT.BORDER | SWT.RIGHT);
          GridDataFactory.create(text).grabH().fillH();
      ...
      checkButton(
          this,
          2,
          PreferencesMessages.MainPreferencePage_showTextInTree,
          IPreferenceConstants.P_GENERAL_TEXT_SUFFIX);
      checkButton(
          this,
          2,
          PreferencesMessages.MainPreferencePage_showImportPropertiesDialog,
          IPreferenceConstants.P_GENERAL_IMPORTANT_PROPERTIES_AFTER_ADD);
      checkButton(
          this,
          2,
          PreferencesMessages.MainPreferencePage_automaticDirectEdit,
      ...
      checkButton(
          this,
          2,
          PreferencesMessages.MainPreferencePage_cascadedStyleMenu,
