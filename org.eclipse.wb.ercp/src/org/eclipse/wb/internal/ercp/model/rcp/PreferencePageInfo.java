...
/**
 * Implementation of {@link AbstractComponentInfo} for {@link PreferencePage}.
 * 
 * @author scheglov_ke
 * @coverage ercp.model.rcp
 */
public final class PreferencePageInfo extends AbstractComponentInfo implements IJavaInfoRendering {
  ...
  public void render() throws Exception {
    ...
    // perform PreferencePage GUI creation
  ...
  protected TopBoundsSupport createTopBoundsSupport() {
    return new PreferencePageTopBoundsSupport(this);
  }
  ...
  /**
   * @return the {@link Shell} on which this {@link PreferencePage} GUI should be created.
   */
  Object getShell() {
    return m_shell;
  }
  ...
  protected void refresh_fetch() throws Exception {
    ControlInfo.refresh_fetch(this, new RunnableEx() {
      public void run() throws Exception {
        PreferencePageInfo.super.refresh_fetch();
      }
    });
  }
}
