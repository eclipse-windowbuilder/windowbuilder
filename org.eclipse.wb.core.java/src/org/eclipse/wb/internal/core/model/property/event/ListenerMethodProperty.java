...
IListenerMethodProperty {
	...
	private class StandardListenerTypeDeclaration extends AbstractListenerTypeDeclaration<TypeDeclaration> {
	...
	private class LambdaListenerTypeDeclaration extends AbstractListenerTypeDeclaration<Expression> {
