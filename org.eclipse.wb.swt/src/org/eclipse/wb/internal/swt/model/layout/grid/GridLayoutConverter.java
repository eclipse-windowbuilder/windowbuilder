...
/**
 * Helper for converting coordinates of {@link CompositeInfo} children to {@link GridLayoutInfo}.
 *
 * @author scheglov_ke
...
public final class GridLayoutConverter {
	...
	public static <T extends IControlInfo> void convert(ICompositeInfo parent,
			IGridLayoutInfo<T> layout) throws Exception {
	...
	private static void applyGeneralLayoutData(IGridDataInfo gridData,
		...
		Integer horizontalAlignmentValue =
				GeneralLayoutData.getRealValue(
						GridLayoutInfo.m_horizontalAlignmentMap,
		...
		Integer verticalAlignmentValue =
				GeneralLayoutData.getRealValue(
						GridLayoutInfo.m_verticalAlignmentMap,
