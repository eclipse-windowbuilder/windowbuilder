...
*link:../userinterface/property_pane.html[Property Pane]*. First select
a component in either the
*link:../userinterface/component_tree.html[Component Tree]* or the
*link:../userinterface/design_view.html[Design View]*. Click the *Show
Events*
image:../userinterface/images/events.gif[image,width=16,height=16]
button to reveal the events list in the
*link:../userinterface/property_pane.html[Property Pane]*. Expand an
...
link:../userinterface/context_menu.html[right-click] on a component
(either in the *link:../userinterface/design_view.html[Design View]* or
in the *link:../userinterface/component_tree.html[Component Tree]*),
...
the *link:../userinterface/source_view.html[Source View]* and go
...
*link:../userinterface/design_view.html[Design View]*. In the
*link:../userinterface/property_pane.html[Property Pane]*, click the
*Show Events*
image:../userinterface/images/events.gif[image,width=16,height=16]
...
*link:../userinterface/property_pane.html[Property Pane]* is a list of
...
*link:../userinterface/design_view.html[Design View]* or in the
*link:../userinterface/component_tree.html[Component Tree]*), and then
...
*link:../userinterface/design_view.html[Design View]* or in the
*link:../userinterface/component_tree.html[Component Tree]*. In the
*link:../userinterface/property_pane.html[Property Pane]* expand expand
