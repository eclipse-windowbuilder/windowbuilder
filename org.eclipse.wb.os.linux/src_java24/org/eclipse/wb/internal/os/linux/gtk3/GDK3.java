...
public class GDK3 extends Native {
	private static class InstanceHolder extends NativeHolder {
		...
		static final MethodHandle gdk_cairo_region = createHandle(GDK, "gdk_cairo_region",
				FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

		static final MethodHandle gdk_cairo_set_source_window = createHandle(GDK, "gdk_cairo_set_source_window",
				FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_DOUBLE, ValueLayout.JAVA_DOUBLE));

		static final MethodHandle gdk_window_get_height = createHandle(GDK, "gdk_window_get_height",
				FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));

		static final MethodHandle gdk_window_get_visible_region = createHandle(GDK, "gdk_window_get_visible_region",
				FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));

		static final MethodHandle gdk_window_get_width = createHandle(GDK, "gdk_window_get_width",
				FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));

		static final MethodHandle gdk_window_is_visible = createHandle(GDK, "gdk_window_is_visible",
				FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN, ValueLayout.ADDRESS));

		static final MethodHandle gdk_window_process_updates = createHandle(GDK, "gdk_window_process_updates",
	...
	public static void gdk_cairo_set_source_window(CairoContext cr, GdkWindow window, double x, double y) {
		MemorySegment segment1 = MemorySegment.ofAddress(cr.handle());
		MemorySegment segment2 = MemorySegment.ofAddress(window.handle());
		runSafe(() -> InstanceHolder.gdk_cairo_set_source_window.invoke(segment1, segment2, x, y));
	}
	...
	public static int gdk_window_get_height(GdkWindow window) {
		...
		return (int) callSafe(() -> InstanceHolder.gdk_window_get_height.invoke(segment));
	}
	...
	public static CairoRegion gdk_window_get_visible_region(GdkWindow window) {
		MemorySegment segment = MemorySegment.ofAddress(window.handle());
		MemorySegment handle = (MemorySegment) callSafe(() -> InstanceHolder.gdk_window_get_visible_region.invoke(segment));
		return new CairoRegion(handle.address());
	}
	...
	public static int gdk_window_get_width(GdkWindow window) {
		MemorySegment segment = MemorySegment.ofAddress(window.handle());
		return (int) callSafe(() -> InstanceHolder.gdk_window_get_width.invoke(segment));
	}
	...
	public static boolean gdk_window_is_visible(GdkWindow window) {
		MemorySegment segment = MemorySegment.ofAddress(window.handle());
		return (boolean) callSafe(() -> InstanceHolder.gdk_window_is_visible.invoke(segment));
	}
	...
	public static void gdk_window_process_updates(GdkWindow window, boolean update_children) {
		MemorySegment segment = MemorySegment.ofAddress(window.handle());
		runSafe(() -> InstanceHolder.gdk_window_process_updates.invoke(segment, update_children));
	}
}
