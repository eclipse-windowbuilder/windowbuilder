...
public abstract class ComponentAbstractDialog extends AbstractPaletteElementDialog {
  ...
  protected void createControls(Composite container) {
    ...
    // class
    {
        ...
        public void changeControlPressed(DialogField field) {
          try {
            String componentClassName =
                JdtUiUtils.selectTypeName(getShell(), m_context.getJavaProject());
      ...
      m_classField.setButtonLabel(Messages.ComponentAbstractDialog_classChoose);
    ...
    // state
    {
      ...
      doCreateField(m_visibleField, Messages.ComponentAbstractDialog_visibleLabel);
    }
  }
  ...
  protected final String validate() {
    // validate class
    {
      ...
      // check for existence
      try {
        m_context.getClassLoader().loadClass(className);
      } catch (Throwable e) {
  ...
  private void prepareComponentDescription() {
    ...
    try {
      ...
      m_componentDescription =
          ComponentDescriptionHelper.getDescription(m_context, componentClassName);
    } catch (Throwable e) {
    }
  }
