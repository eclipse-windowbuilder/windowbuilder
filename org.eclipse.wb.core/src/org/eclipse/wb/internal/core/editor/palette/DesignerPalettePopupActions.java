...
final class DesignerPalettePopupActions {
  ...
  private void addPopupActions_edit(IMenuManager menuManager, Object target) {
    ...
    // factories
    {
      ...
      {
        IMenuManager staticMenuManager = new MenuManager("Add static factory");
      ...
      {
        IMenuManager instanceMenuManager = new MenuManager("Add instance factory");
    ...
    menuManager.add(new Separator());
    // Jar
    menuManager.add(new Action("Import Jar...", IMPORT_JAR_IMAGE) {
      @Override
      public void run() {
        // prepare initial "next category"
        CategoryInfo nextCategory = null;
