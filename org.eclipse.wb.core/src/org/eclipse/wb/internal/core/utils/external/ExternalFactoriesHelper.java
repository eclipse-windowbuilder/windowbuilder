...
public class ExternalFactoriesHelper {
	...
	/**
	 * @param className the name of {@link Class} to load.
	 *
	 * @return the {@link Class} loaded from this {@link ClassLoader} or from
	 *         {@link Bundle} that specifies that it can load class from some
	 *         namespace.
	 */
	...
	/**
	 * {@link IRegistryChangeListener} for tracking changes for interesting
	 * extensions.
	 */
	 ...
	 * <p>
	 * Objects are sorted by their optional "priority" attribute (descending). If
	 * "priority" is absent, "0" is used.
	 *
	 * @param clazz       the {@link Class} of elements instances.
	 * @param pointId     the qualified id of extension, e.g.
	 *                    <code>"org.eclipse.core.builders"</code>.
	 * @param elementName the name of element inside of extension, e.g.
	 *                    <code>"builder"</code>.
	 *
	 ...
	 *                    <code>"builder"</code>.
	 *
	 * @return {@link IConfigurationElement}'s of all elements for specified
	 *         extension point and element name.
	 */
	...
	/**
	 * {@link IConfigurationElement} may become invalid when their
	 * {@link IExtension} was removed, or even when corresponding {@link Bundle} was
	 * uninstalled.
	 */
	 ...
	 *
	 * @param pointId     the ID of extension point to find extension for.
	 * @param extensionId the qualified ID of extension, such as
	 *                    <code>"com.google.gdt.eclipse.designer.GWTNature"</code>.
	 *
	 * @return the {@link IConfigurationElement} for found extension, or
	 ...
	 *
	 * @param pointId the ID of extension point to get extensions for.
	 */
	...
	/**
	 * @return the {@link org.osgi.framework.Bundle} that defines given
	 ...
	 *
	 * @exception IllegalArgumentException if no attribute with such name found.
	 */
	 ...
	 *         path in given attribute. May be <code>null</code> if no value for
	 *         attribute.
	 */
