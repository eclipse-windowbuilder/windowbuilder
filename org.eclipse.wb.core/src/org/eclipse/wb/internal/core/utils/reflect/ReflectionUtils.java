...
public class ReflectionUtils {
	...
	public static boolean isEnchancedClass(Class<?> clazz) {
		return isEnchancedClass(clazz.getName());
	}

	/**
	 * @return <code>true</code> if given {@code class name} that is "enchanced", i.e. is generated by
	 *         "ByteBuddy", or some other library.
	 */
	public static boolean isEnchancedClass(String className) {
	...
	public static Object invokeMethod(Object object, String signature, Object... arguments)
		...
		// do invoke
		return invokeMethod(method, refObject, arguments);
	}

	/**
	 * @return the {@link Object} result of invoking method with given arguments.
	 */
