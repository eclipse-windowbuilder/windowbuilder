 ...
 */
public class LayoutDialogFieldGroup extends DialogField {
   ...
   */
  public LayoutDialogFieldGroup(int buttonsStyle, String[] buttonNames, int nColumns) {
   ...
   */
  public LayoutDialogFieldGroup(int buttonsStyle,
      String[] buttonNames,
      int nColumns,
      int borderStyle) {
    super();
