...
public final class TreeModelDialog extends ResizableDialog {
  ...
  private static final Image IMAGE_FOLDER =
      new Image(null, TreeModelDialog.class.getResourceAsStream("icons/folder.gif"));
  private static final Image IMAGE_LEAF =
      new Image(null, TreeModelDialog.class.getResourceAsStream("icons/leaf.gif"));
