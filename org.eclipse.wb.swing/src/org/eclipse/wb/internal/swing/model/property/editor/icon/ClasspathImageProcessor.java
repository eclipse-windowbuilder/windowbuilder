...
/**
 * Default implementation for handling AWT {@link Image}s via the classpath.
 */
public final class ClasspathImageProcessor extends AbstractClasspathImageProcessor {
	...
	public boolean postOpen(IGenericProperty property, String path, String[] value) {
		...
		value[0] = "java.awt.Toolkit.getDefaultToolkit().getImage({wbp_classTop}.getResource(" + pathSource + "))";
		return true;
	}
}
