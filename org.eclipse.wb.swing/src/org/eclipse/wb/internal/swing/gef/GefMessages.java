...
public class GefMessages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.wb.internal.swing.gef.GefMessages"; //$NON-NLS-1$
	...
	public static String ColumnSelectionEditPolicy_feedbackPattern;
	public static String ColumnsLayoutEditPolicy_feedbackPattern;
	public static String GridBagLayoutEditPolicy_appendColumn;
	public static String GridBagLayoutEditPolicy_appendRow;
	public static String JScrollPaneLayoutEditPolicy_columnHeader;
	public static String JScrollPaneLayoutEditPolicy_rowHeader;
	public static String JScrollPaneLayoutEditPolicy_viewport;
	public static String JSplitPaneLayoutEditPolicy_leftTop;
	public static String JSplitPaneLayoutEditPolicy_rightBottom;
	public static String MenuBarDropLayoutEditPolicy_feedbackText;
	...
	public static String RowHeaderEditPart_vaAboveBaseline;
	public static String RowHeaderEditPart_vaBaseline;
	public static String RowHeaderEditPart_vaBelowBaseline;
	...
	public static String RowSelectionEditPolicy_feedbackPattern;
