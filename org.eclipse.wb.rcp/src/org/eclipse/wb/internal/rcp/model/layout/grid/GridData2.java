...
public final class GridData2 {
   ...
   * Control.computeSize(int, int, boolean) to determine the preferred size of the control.
   * 
  ...
  /**
   * heightHint specifies the preferred height in pixels. This value is the hHint passed into
   * Control.computeSize(int, int, boolean) to determine the preferred size of the control.
   * 
   * The default value is SWT.DEFAULT.
   * 
  ...
  /**
   * horizontalIndent specifies the number of pixels of indentation that will be placed along the
  ...
  /**
   * verticalIndent specifies the number of pixels of indentation that will be placed along the top
   * side of the cell.
   * 
   * The default value is 0.
   * 
   ...
   * of the parent Composite. If grabExcessHorizontalSpace is <code>true</code>, the following rules
   ...
   * <li>If there is not enough horizontal space available in the parent, the cell will shrink until
   * it reaches its minimum width as specified by GridData.minimumWidth. The new width will be the
   * maximum of "minimumWidth" and "preferred width - delta", where delta is the amount of space
   * missing divided by the number of grabbing columns.</li>
   * <li>If the parent is packed, the cell will be its preferred width as specified by
   * GridData.widthHint.</li>
   * <li>If the control spans multiple columns and there are no other grabbing controls in any of
   * the spanned columns, the last column in the span will grab the extra space. If there is at
   * least one other grabbing control in the span, the grabbing will be spread over the columns
   * already marked as grabExcessHorizontalSpace.</li>
   * </ul>
   * 
   * <p>
   ...
   * </p>
   * 
   * @see GridData2#minimumWidth
   * @see GridData2#widthHint
   */
  public boolean grabExcessHorizontalSpace = false;
  /**
   * <p>
   * grabExcessVerticalSpace specifies whether the height of the cell changes depending on the size
   * of the parent Composite. If grabExcessVerticalSpace is <code>true</code>, the following rules
   ...
   * it reaches its minimum height as specified by GridData.minimumHeight. The new height will be
   * the maximum of "minimumHeight" and "preferred height - delta", where delta is the amount of
   * space missing divided by the number of grabbing rows.</li>
   * <li>If the parent is packed, the cell will be its preferred height as specified by
   * GridData.heightHint.</li>
   * <li>If the control spans multiple rows and there are no other grabbing controls in any of the
   * spanned rows, the last row in the span will grab the extra space. If there is at least one
   * other grabbing control in the span, the grabbing will be spread over the rows already marked as
   ...
   * </p>
   * 
   * @see GridData2#minimumHeight
   * @see GridData2#heightHint
   */
  public boolean grabExcessVerticalSpace = false;
  /**
   * minimumWidth specifies the minimum width in pixels. This value applies only if
   * grabExcessHorizontalSpace is true. A value of SWT.DEFAULT means that the minimum width will be
   * the result of Control.computeSize(int, int, boolean) where wHint is determined by
   * GridData.widthHint.
   * 
   * The default value is 0.
   * 
  ...
  /**
   * minimumHeight specifies the minimum height in pixels. This value applies only if
   * grabExcessVerticalSpace is true. A value of SWT.DEFAULT means that the minimum height will be
   * the result of Control.computeSize(int, int, boolean) where hHint is determined by
   * GridData.heightHint.
   * 
   * The default value is 0.
   * 
  ...
  /**
   * exclude informs the layout to ignore this control when sizing and positioning controls. If this
   * value is <code>true</code>, the size and position of the control will not be managed by the
   * layout. If this value is <code>false</code>, the size and position of the control will be
  ...
  /**
   * Style bit for <code>new GridData(int)</code>. Position the control at the top of the cell. Not
   * recommended. Use <code>new GridData(int, SWT.BEGINNING, boolean, boolean)</code> instead.
   */
  public static final int VERTICAL_ALIGN_BEGINNING = 1 << 1;
  /**
   * Style bit for <code>new GridData(int)</code> to position the control in the vertical center of
   * the cell. Not recommended. Use <code>new GridData(int, SWT.CENTER, boolean, boolean)</code>
   * instead.
   */
  public static final int VERTICAL_ALIGN_CENTER = 1 << 2;
  /**
   * Style bit for <code>new GridData(int)</code> to position the control at the bottom of the cell.
   * Not recommended. Use <code>new GridData(int, SWT.END, boolean, boolean)</code> instead.
   */
  public static final int VERTICAL_ALIGN_END = 1 << 3;
  /**
   * Style bit for <code>new GridData(int)</code> to resize the control to fill the cell vertically.
   * Not recommended. Use <code>new GridData(int, SWT.FILL, boolean, boolean)</code> instead
   */
  public static final int VERTICAL_ALIGN_FILL = 1 << 4;
  /**
   * Style bit for <code>new GridData(int)</code> to position the control at the left of the cell.
   * Not recommended. Use <code>new GridData(SWT.BEGINNING, int, boolean, boolean)</code> instead.
   */
  public static final int HORIZONTAL_ALIGN_BEGINNING = 1 << 5;
  /**
   * Style bit for <code>new GridData(int)</code> to position the control in the horizontal center
   * of the cell. Not recommended. Use <code>new GridData(SWT.CENTER, int, boolean, boolean)</code>
   * instead.
   */
  public static final int HORIZONTAL_ALIGN_CENTER = 1 << 6;
  /**
   * Style bit for <code>new GridData(int)</code> to position the control at the right of the cell.
   * Not recommended. Use <code>new GridData(SWT.END, int, boolean, boolean)</code> instead.
   */
  public static final int HORIZONTAL_ALIGN_END = 1 << 7;
  /**
   * Style bit for <code>new GridData(int)</code> to resize the control to fill the cell
   * horizontally. Not recommended. Use <code>new GridData(SWT.FILL, int, boolean, boolean)</code>
   * instead.
   */
  public static final int HORIZONTAL_ALIGN_FILL = 1 << 8;
  /**
   * Style bit for <code>new GridData(int)</code> to resize the control to fit the remaining
   * horizontal space. Not recommended. Use <code>new GridData(int, int, true, boolean)</code>
   * instead.
   */
  public static final int GRAB_HORIZONTAL = 1 << 9;
  /**
   * Style bit for <code>new GridData(int)</code> to resize the control to fit the remaining
   * vertical space. Not recommended. Use <code>new GridData(int, int, boolean, true)</code>
   * instead.
   */
   ...
   * | GRAB_HORIZONTAL Not recommended. Use <code>new GridData(SWT.FILL, int, true, boolean)</code>
   * instead.
   */
