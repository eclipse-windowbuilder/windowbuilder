 ...
 */
public final class TableWrapData2 {
  /**
  ...
  /**
   * In addition to filling width or height, the control will take part in allocation of any excess
   * space. Note that this constant can only be passed to the constructor (cannot be directly
   * assigned to <code>align</code> variable).
   */
  ...
  /**
   * If <code>true</code>, take part in excess horizontal space distribution. (default is
   * <code>false</code>).
   */
  public boolean grabHorizontal;
  /**
   * If <code>true</code>, will grab any excess vertical space (default is <code>false</code>). Note
   * that since TableWrapLayout works top-down and does not grows to fill the parent, this only
   * applies to local excess space created by fixed-height children that span multiple rows.
   */
   ...
   */
  public TableWrapData2(int align) {
    this(align, TOP, 1, 1);
  }
   ...
   */
  public TableWrapData2(int align, int valign) {
   ...
   */
  public TableWrapData2(int align, int valign, int rowspan, int colspan) {
