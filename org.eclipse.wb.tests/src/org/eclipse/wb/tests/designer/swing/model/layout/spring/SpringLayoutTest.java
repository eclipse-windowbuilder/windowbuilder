...
public class SpringLayoutTest extends AbstractLayoutTest {
				...
				public class Test extends JPanel {
					public Test() {
						...
						setLayout(layout);
						{
							JButton button = new JButton();
							layout.putConstraint(SpringLayout.WEST, button, 50, SpringLayout.WEST, this);
							layout.putConstraint(SpringLayout.EAST, button, %d, SpringLayout.WEST, this);
							add(button);
						}
					}
				}""".formatted(50 + preferredSize.width));
	}
	...
	public void test_setExplicitSize_horizontal_leadingAttached_resizeTrailing() throws Exception {
		...
		assertEditor("""
				...
				}""".formatted((5 + preferredSize.width + 10)));
	}
		...
		assertEditor("""
				public class Test extends JPanel {
					public Test() {
						...
						{
							JButton button = new JButton();
							layout.putConstraint(SpringLayout.WEST, button, %d, SpringLayout.EAST, this);
							layout.putConstraint(SpringLayout.EAST, button, -50, SpringLayout.EAST, this);
							add(button);
						}
					}
				...
				public class Test extends JPanel {
					public Test() {
						...
						setLayout(layout);
						{
							JButton button = new JButton();
							layout.putConstraint(SpringLayout.NORTH, button, 50, SpringLayout.NORTH, this);
							layout.putConstraint(SpringLayout.SOUTH, button, %d, SpringLayout.NORTH, this);
							add(button);
						}
					}
				}""".formatted(50 + preferredSize.height));
	}
	...
	public void test_setExplicitSize_vertical_leadingAttached_resizeTrailing() throws Exception {
		...
		assertEditor("""
				...
				}""".formatted(5 + preferredSize.height + 10));
	}
		...
		assertEditor("""
				public class Test extends JPanel {
					public Test() {
						...
						{
							JButton button = new JButton();
							layout.putConstraint(SpringLayout.NORTH, button, %d, SpringLayout.SOUTH, this);
							layout.putConstraint(SpringLayout.SOUTH, button, -50, SpringLayout.SOUTH, this);
							add(button);
						}
					}
