...
public class TabFolderTest extends RcpModelTest {
	...
	public void test_getSelectedItem_1() throws Exception {
		...
		Assertions.<Object>assertThat(tabFolder.getObject().getSelection()).containsOnly(item_2.getObject());
	...
	public void test_parseItems() throws Exception {
		...
		// text
		assertEquals("000", item_0.getObject().getText());
		assertEquals("111", item_1.getObject().getText());
		// bounds for "item_0"
		{
